...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"dynamicMsgBrokerClass":"msgbroker-crossplane-where-for-dinner","bsGitBranch":"main","artifactVersion":"0.0.1-beta","bsGitRepository":"github.com?owner=tap-labs&repo=where-for-dinner","dynamicMsgBroker":true,"dbType":"h2","enableCloudEvents":false,"enableSecurity":false,"includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","numRabbitMQClusterNodes":1,"secureProfile":"secure","artifactId":"where-for-dinner","serviceNamespace":"delta","msgBrokerType":"rabbitmq","projectName":"where-for-dinner","workloadNamespace":"delta","cacheType":"inmemCache"}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input16872128795346631468, --data-values-file, /tmp/accelerator-options3619125403151361894.json, --output-files, /tmp/ytt-output17889945160695942819]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=tap-labs&repo=where-for-dinner'
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"dynamicMsgBrokerClass":"msgbroker-crossplane-where-for-dinner","bsGitBranch":"main","artifactVersion":"0.0.1-beta","bsGitRepository":"github.com?owner=tap-labs&repo=where-for-dinner","dynamicMsgBroker":true,"dbType":"h2","enableCloudEvents":false,"enableSecurity":false,"includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","numRabbitMQClusterNodes":1,"secureProfile":"secure","artifactId":"where-for-dinner","serviceNamespace":"delta","msgBrokerType":"rabbitmq","projectName":"where-for-dinner","workloadNamespace":"delta","cacheType":"inmemCache"}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input14755793102805779975, --data-values-file, /tmp/accelerator-options5440333485327602981.json, --output-files, /tmp/ytt-output11501289928627761593]
